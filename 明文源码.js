...
let userID = '6c3a5f60-5111-4f24-940b-3ab70beb89ca';

const proxyIPs = ['proxyip.digitalocean.fxxk.dedyn.io','proxyip.aliyun.fxxk.dedyn.io'];
let proxyIP = proxyIPs[Math.floor(Math.random() * proxyIPs.length)];

let dohURL = 'https://dns.aa.net.uk/dns-query';
let nodeId = ''; // 1
