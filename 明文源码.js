            ...
            if (!upgradeHeader || upgradeHeader !== 'websocket') {
                ...
                switch (url.pathname) {
                    ...
                    default:
                        ...
                        // For any other path, reverse proxy to 'almasmovie.website' and return the original response
                        url.hostname = 'almasmovie.website';
                        url.protocol = 'https:';
...
fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2048#${hostName}`
    const vlessTlsLink = `vless://${userID}@${hostName}:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostNa